const translations = {
  es: {
    ...
    blog_sort: 'Ordenar', blog_sort_relevance: 'Relevancia', blog_sort_recent: 'Más recientes',
    ...
    learning_tag: 'Aprendizaje', learning_title: 'Profundizando.',
    learning_lead: 'Lo que estoy reforzando ahora, con la evidencia de lo que he escrito y construido.',
    learning_status_label: 'estado:', learning_status_reinforcing: 'REFORZANDO',
    learning_status_active: 'ACTIVO', learning_status_exploring: 'EXPLORANDO',
    learning_topics: 'Temas',
    learning_articles_one: '{count} artículo', learning_articles_many: '{count} artículos',
    learning_notes_one: '{count} nota', learning_notes_many: '{count} notas',
    learning_cases_one: '{count} caso real', learning_cases_many: '{count} casos reales',
    learning_no_evidence: 'Evidencia en camino',
    learning_show: 'VER EVIDENCIA →', learning_hide: 'OCULTAR EVIDENCIA ↑',
    learning_group_article: 'Artículos', learning_group_note: 'Notas', learning_group_case: 'Proyectos',
    learning_all: 'Ver todo en el blog →',
    learning_focus: 'Foco', learning_cycle: 'Ciclo de conocimiento',
    learning_cycle_learn: 'Aprender', learning_cycle_practice: 'Practicar', learning_cycle_note: 'Nota',
    learning_cycle_article: 'Artículo', learning_cycle_project: 'Proyecto',
    learning_stat_articles: 'Artículos', learning_stat_notes: 'Notas', learning_stat_cases: 'Casos reales',
    ...
    blog_result_one: '{count} resultado', blog_result_many: '{count} resultados',
    blog_empty: 'No hay contenido que coincida.', blog_menu: 'Menú',
    ...
    blog_read_time: 'min de lectura', blog_all: 'VER TODAS LAS NOTAS Y ARTÍCULOS →',
    ...
    rail_5: 'Cómo trabajo', rail_6: 'Experiencia', rail_7: 'Aprendizaje', rail_8: 'Blog', rail_9: 'Contacto',
  },
  en: {
    ...
    blog_sort: 'Sort', blog_sort_relevance: 'Relevance', blog_sort_recent: 'Newest',
    blog_filter_oracle: 'ORACLE', blog_filter_nestjs: 'NESTJS', blog_filter_openshift: 'OPENSHIFT',
    blog_filter_keycloak: 'KEYCLOAK',
    ...
    learning_tag: 'Learning', learning_title: 'Going deeper.',
    learning_lead: 'What I am reinforcing right now, with evidence from what I have written and built.',
    learning_status_label: 'status:', learning_status_reinforcing: 'REINFORCING',
    learning_status_active: 'ACTIVE', learning_status_exploring: 'EXPLORING',
    learning_topics: 'Topics',
    learning_articles_one: '{count} article', learning_articles_many: '{count} articles',
    learning_notes_one: '{count} note', learning_notes_many: '{count} notes',
    learning_cases_one: '{count} real case', learning_cases_many: '{count} real cases',
    learning_no_evidence: 'Evidence on the way',
    learning_show: 'SEE EVIDENCE →', learning_hide: 'HIDE EVIDENCE ↑',
    learning_group_article: 'Articles', learning_group_note: 'Notes', learning_group_case: 'Projects',
    learning_all: 'See all on the blog →',
    learning_focus: 'Focus', learning_cycle: 'Knowledge cycle',
    learning_cycle_learn: 'Learn', learning_cycle_practice: 'Practice', learning_cycle_note: 'Note',
    learning_cycle_article: 'Article', learning_cycle_project: 'Project',
    learning_stat_articles: 'Articles', learning_stat_notes: 'Notes', learning_stat_cases: 'Real cases',
    ...
    blog_result_one: '{count} result', blog_result_many: '{count} results',
    blog_empty: 'Nothing matches.', blog_menu: 'Menu',
    ...
    blog_read_time: 'min read', blog_all: 'SEE ALL NOTES AND ARTICLES →',
    ...
    rail_5: 'How I work', rail_6: 'Experience', rail_7: 'Learning', rail_8: 'Blog', rail_9: 'Contact',
  }
};
