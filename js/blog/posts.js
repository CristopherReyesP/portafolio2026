// Add a post: create blog/posts/<slug>.html and add one entry here, then run
// node scripts/build-content.mjs (search index, sitemap, RSS). Short notes and
// Markdown articles live in content/ instead (see content/README.md).
// type: 'article'; updated: last review date; learning: ids from js/learning/focuses.js;
// relatedCase: id of the related case on the home page (the post's relatedProject).
